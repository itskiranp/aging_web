...
<section class="py-4 bg-light">
    <div class="container" style="line-height: 1.8;">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <div class="comment-box mt-3" style="margin-bottom: 18px; font-size: 1.1rem; line-height: 1.8;">
            ...
            <div class="col-md-6">
                ...
                <div class="comment-box mt-3" style="margin-bottom: 18px; font-size: 1.1rem; line-height: 1.5;">
