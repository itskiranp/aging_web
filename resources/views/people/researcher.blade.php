    ...
    <div class="container text-center my-5">
        ...
        <div class="my-5">
            <div class="row justify-content-center">
                ...
                <div class="col-6 col-md-3">
                    <div class="team-member">
                        <img src="/images/Dr.%20Kenneth%20M.%20Langa.JPG" alt="Dr. Kenneth M. Langa"
                            class="img-fluid rounded-circle mb-3">
                ...
                <div class="col-6 col-md-3">
                    <div class="team-member">
                        <img src="/images/Uttam-Sharma.jpg" alt="Uttam Sharma" class="img-fluid rounded-circle mb-3">
