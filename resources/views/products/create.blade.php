...
<html lang="en">
  <head>
    ...
    <title>Simple Laravel11 crud</title>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="row d-flex jusify-content-center px-5">
            <div class="col-md-10">
                <div class="card borde-0 shadow-lg my-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control"  cols="30" rows="5" placeholder="Description" name="Description" {{ old('Description') }}></textarea>
