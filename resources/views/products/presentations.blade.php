...
@section('content')
    ...
    <div class="container py-5">
        <h1 class="gallery-title">Presentation</h1>
        <!-- Presentations List -->
        <div class="row">
            <!-- 2024 Presentations -->
            <div class="col-12 mb-3">
                <h2 class="section-header fs-2 fw-semibold text-dark">2024</h2>
                    ...
                    <div class="col-12">
                        <div class="presentation-card bg-white rounded p-4 position-relative">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                <div class="me-md-4 mb-3 mb-md-0 text-primary fs-2">
                                    <i class="fas fa-microphone"></i>
                                </div>
                                <div class="flex-grow-1">
                                    <h3 class="h4 fw-semibold text-dark mb-2">Adapting the HCAP in Nepal: The Chitwan Valley Family Study</h3>
            ...
            <div class="col-12 mb-5">
                <h2 class="section-header fs-2 fw-semibold text-dark">2023</h2>
                    ...
                    <div class="col-12">
                        <div class="presentation-card bg-white rounded p-4 position-relative">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                ...
                                <div class="flex-grow-1">
                                    <h3 class="h4 fw-semibold text-dark mb-2">CVFS-Study on Cognition and Aging in Nepal (CVFS-SCAN)</h3>
                    ...
                    <div class="col-12">
                        <div class="presentation-card bg-white rounded p-4 position-relative">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                ...
                                <div class="flex-grow-1">
                                    <h3 class="h4 fw-semibold text-dark mb-2">International Labor Migration, Armed Conflict and Dementia Risk in Nepal</h3>
                    ...
                    <div class="col-12">
                        <div class="presentation-card bg-white rounded p-4 position-relative">
                            ...
                            <div class="d-flex flex-column flex-md-row">
                                ...
                                <div class="flex-grow-1">
                                    <h3 class="h4 fw-semibold text-dark mb-2">Population-Based Dementia Assessment in Nepal</h3>
