...
<div class="container mt-4 mb-5">
    ...
    <div><h2 class="gallery-title">General Interviewing Techniques(GIT)</h2></div>
    ...
    <div class="container my-4" style="width: 100%;">
        ...
        <p style="font-size:1rem; text-align:justify;">
            <strong>20 enumerators</strong> with diverse backgrounds completed the training and
        ...
        <ul style="font-size:1rem; line-height:1.6;">
            <li>Improved understanding of <strong>ethics and confidentiality</strong>.</li>
            <li>Enhanced skills in <strong>question delivery, probing, and response recording</strong>.</li>
        ...
        <div style="border-left:4px solid #2b6cb0; padding-left:15px; margin:15px 0;">
            ...
            <p style="font-size:1rem; margin-top:5px; text-align:justify;">
                Focused on <strong>effective probing, active listening, ethical handling of sensitive topics, and standardized interviewing</strong>.
        ...
        <h4 style="color:#444; font-weight:600;">Participants</h4>
        <p style="font-size:1rem; text-align:justify;">
            <strong>40+ enumerators</strong> took part, each completing <strong>five supervised practice interviews</strong> before production surveys using Blaise.
        </p>
        <h4 style="color:#444; font-weight:600;">Outcomes</h4>
        <ul style="font-size:1rem; line-height:1.6;">
